...
import { auth, provider, signInWithPopup } from '../../firebase' // Add signInWithPopup
...
function Login() {
  ...
  const signIn = () => {
    setLoading(true)
    signInWithPopup(auth, provider) // Use the imported signInWithPopup function
